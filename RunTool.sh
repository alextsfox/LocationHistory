...
python3 colorImage.py $dir/FilteredLocations_Full.csv $dir/figs/TrimBox_CLE.png -t $N $W $S $E
...
python3 makeAnimateFromNPY.py $dir/figs/TrimBox_CLE_005k.mp4 -t $N $W $S $E -v